...
#define ARM_CPU_FLAG_VFP_D32        0x0800      /* VFP has 32 double registers */
#define ARM_CPU_FLAG_LPAE           0x1000      /* LPAE support is present and enabled */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/services/system/public/arm/syspage.h $ $Rev: 759590 $")
#endif
