...
/* On the iMX6D or iMX6Q there are five ECSPI and three I2C peripherals
 * so CCGR1_CG4 enables the clock for ECSPI5.
 * On the iMX6S or iMX6DL the four ECSPI and four I2C peripherals so
 * CCGR1_CG4 enales the clock for I2C4
 */
#define CCGR1_CG4_ECSPI5                        (0x3 << 8)
#define CCGR1_CG4_I2C4                          (0x3 << 8)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/startup/lib/public/arm/mx6x.h $ $Rev: 787667 $")
#endif
