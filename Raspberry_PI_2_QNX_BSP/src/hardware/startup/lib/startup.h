...
/*
 * ------------------------------------------------------------------
 * Broadcom 2836 (Raspberry Pi 2) support
 * Add by Quyet Luu
 * ------------------------------------------------------------------
 */
extern void init_bcm2836(unsigned channel, const char *init, const char *defaults);
extern void put_bcm2836(int);
extern struct callout_rtn       display_char_bcm2836;
extern struct callout_rtn       poll_key_bcm2836;
extern struct callout_rtn       break_detect_bcm2836;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/startup/lib/startup.h $ $Rev: 783859 $")
#endif
