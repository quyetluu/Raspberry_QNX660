...
extern const struct armv_cache	armv_cache_a5up;
...
extern const struct armv_cache	armv_cache_a57;
...
extern const struct armv_chip	armv_chip_a5;
extern const struct armv_chip	armv_chip_a5up;
 ...
 * ------------------------------------------------------------------
 */
extern const struct armv_chip	*armv_detect_a5(void);

extern struct callout_rtn	page_flush_a5up;
extern struct callout_rtn	page_flush_deferred_a5up;
extern struct callout_rtn	cache_a5up_i;
extern struct callout_rtn	cache_a5up_d;
extern void					armv_setup_a5up(struct cpuinfo_entry *, unsigned);
 ...
 * ------------------------------------------------------------------
 */
extern const struct armv_chip	*armv_detect_a57(void);

extern struct callout_rtn	page_flush_a57;
extern struct callout_rtn	page_flush_deferred_a57;
extern struct callout_rtn	cache_a57_i;
extern struct callout_rtn	cache_a57_d;
extern void					armv_setup_a57(struct cpuinfo_entry *, unsigned);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/startup/lib/arm/cpu_startup.h $ $Rev: 786684 $")
#endif
