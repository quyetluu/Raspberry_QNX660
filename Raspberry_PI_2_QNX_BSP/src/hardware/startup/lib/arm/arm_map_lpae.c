...
lpae_set_prot(paddr64_t paddr, unsigned flags)
{
	...
	// so we handle these inline and then return
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/startup/lib/arm/arm_map_lpae.c $ $Rev: 771846 $")
#endif
