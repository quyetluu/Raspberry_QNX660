...
extern struct callout_rtn	timer_load_bcm2836;
extern struct callout_rtn	timer_value_bcm2836;
extern struct callout_rtn	timer_reload_bcm2836;
...
static const struct callout_slot	timer_callouts[] = {
	{ CALLOUT_SLOT(timer_load, _bcm2836) },
	{ CALLOUT_SLOT(timer_value, _bcm2836) },
	{ CALLOUT_SLOT(timer_reload, _bcm2836) },
};
